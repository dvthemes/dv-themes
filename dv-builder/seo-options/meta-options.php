...
function seo_meta_box_callback($post) {
	...
	?>
		...
		<style>
			...
			#seo_meta_box { background: #e6e4ff; border: 2px solid #3f3b62; margin: 0 10px 20px; }
			#seo_meta_box .postbox-header:hover,
			#seo_meta_box .postbox-header { background: #3f3b62 !important; margin: 0 0 20px; border: 0; }
			#seo_meta_box .postbox-header h2 { color:#fff !important; }
			...
			#seo_box .box_wrpr button { cursor:pointer; display: block; background: #3f3b62; padding: 10px 30px; border: 1px solid #3f3b62; border-radius: 5px; text-transform: uppercase; font-weight: 700; }
